...
1. **AI Resume Analyzer** (Python, Streamlit, NLP)
   - Built an ATS-based resume analyzer that evaluates resumes and provides improvement suggestions.
2. **Food Waste Reduction Website** (HTML, CSS, JavaScript, Node.js, MySQL)
   - Developed a platform connecting restaurants with NGOs to reduce food wastage.
3. **Sales Data Analytics Dashboard** (Power BI, Excel, SQL)
   - Designed an interactive dashboard to analyze sales trends, revenue, and customer insights.
4. **Study Buddy** (Java, Web Development)
   - Developed a collaborative educational app for tracking tasks and sharing resources.
